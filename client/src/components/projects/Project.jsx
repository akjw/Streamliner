          ...
          <Row className="mt-4">
            <Col>
                 {project.phases.length ?
                  <Collapse accordion bordered={false} defaultActiveKey={project.activePhase ? project.activePhase : project.phases[0]._id}>
                  ...
                  </div>} key={phase._id} className="accordion-theme">
                  <AnCard className="" extra={ <h4> 
                         ...
                         : ''}
                          ...
                          <h4 className="mb-4">{phase.subheader}</h4>
                                <Container fluid className="mt-4">
                                <Row>
